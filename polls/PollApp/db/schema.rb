...
ActiveRecord::Schema.define(version: 20170615203629) do
  ...
  create_table "answer_choices", force: :cascade do |t|
    ...
    t.index ["answer_choice", "question_id"], name: "index_answer_choices_on_answer_choice_and_question_id", unique: true, using: :btree
  end
